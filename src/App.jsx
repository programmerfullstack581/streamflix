  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 flex font-sans selection:bg-sky-400 selection:text-white">
      ...
      <div className="flex-1 flex flex-col min-w-0 pb-20 md:pb-8">
        ...
        {/* Barra Superior */}
        <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md px-4 sm:px-8 py-3.5 border-b border-sky-100/80 select-none shadow-xs">
          <div className="max-w-6xl mx-auto flex items-center justify-between gap-3">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="p-2 -ml-2 text-slate-600 hover:text-slate-900 rounded-xl hover:bg-slate-100 md:hidden cursor-pointer"
              ...
              >
                <div className="w-9 h-9 rounded-2xl bg-gradient-to-tr from-sky-400 to-sky-600 flex items-center justify-center shadow-md shadow-sky-400/20 text-white flex-shrink-0">
                  <Radio className="w-4 h-4 font-black" />
                </div>
                <div>
                  <div className="flex items-center space-x-1">
                    <span className="text-lg font-black text-slate-900 tracking-tight">STREAM</span>
                    <span className="text-lg font-black text-sky-500 tracking-tight">BEAT</span>
                  </div>
                  <span className="text-[8px] sm:text-[9px] font-bold uppercase tracking-wider text-sky-700 bg-sky-50 px-2 py-0.5 rounded-full border border-sky-100">
                    MP3 (320k) & MP4 (1080p)
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center space-x-2.5">
              ...
              <button
                ...
                className="flex items-center space-x-1.5 px-3.5 py-2 bg-gradient-to-r from-sky-400 via-sky-500 to-blue-500 hover:from-sky-500 hover:to-blue-600 text-white rounded-xl text-xs font-bold transition-all shadow-md shadow-sky-400/20 cursor-pointer active:scale-95"
        ...
        <main className="max-w-6xl w-full mx-auto px-4 sm:px-8 py-6 sm:py-8">
          {activeTab === 'inicio' ? (
            <DownloadsView
              downloads={downloads}
      ...
      {/* 3. Barra de Navegación Inferior Flotante (100% Mobile Responsive) */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-sky-100 py-2 px-6 flex justify-around items-center shadow-lg">
